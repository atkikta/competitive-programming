...
public class Main {
    ...
    void solve() throws IOException {
        ...
        for (int i = 0; i < 26; i++) {
            four += wordcount[i]/4;
            wordcount[i] = wordcount[i]%4;
            two += wordcount[i]/2;
            wordcount[i] = wordcount[i]%2;
            one += wordcount[i];
        }
        ...
        if(W%2==0 && H%2==0){
            int fourcount = W*H/4;
            if(one==0 && four>=fourcount) out.println("Yes");
            else out.println("No");
        }else if(W%2==1&&H%2==0){
            int fourcount = H*(W-1)/4;
            if(one==0 && four>=fourcount)out.println("Yes");
            else out.println("No");
        }else if(W%2==0&&H%2==1){
            int fourcount = W*(H-1)/4;
            if(one==0 && four>=fourcount)out.println("Yes");
            else out.println("No");
        }else{
            int fourcount = (W-1)*(H-1)/4;
            if(one == 1&&four>=fourcount) out.println("Yes");
            else out.println("No");
        }
    }
